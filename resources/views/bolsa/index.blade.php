        ...
        <table class="table align-middle caption-top table-striped">
            ...
            <thead>
                <div class="d-flex justify-content-between align-items-center mb-2">
                    <a href="{{ route('bolsa.create') }}" class="btn btn-primary"> 
            ...
            <tbody>
                @foreach ($data as $item)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('bolsa.edit', $item->id) }}" class="btn btn-success">
                        ...
                        <form action="{{ route('bolsa.destroy', $item->id) }}" method="POST" id="form_{{$item->id}}">
                            @csrf
                            @method('DELETE')
                        </form>
                    </tr>
