            ...
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-dark text-white py-3">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('prova.create') }}" class="btn btn-light">
                                            ...
                                            @if ($item->documento)
                                                <div class="btn-group">
                                                    <button type="button" class="btn btn-dark btn-sm"
                                                        onclick="showPDF('{{ asset('storage/' . $item->documento) }}', '{{ $item->titulo }}')"
                                                    ...
                                                    <a href="{{ asset('storage/' . $item->documento) }}" download
                                                        class="btn btn-dark btn-sm" title="Baixar PDF">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
    ...
    <div class="modal-dialog modal-xl modal-fullscreen-lg-down">
        <div class="modal-content">
            ...
            <div class="modal-footer bg-light">
                ...
                <span id="pageInfo" class="mx-3">Página <span id="currentPage">0</span> de <span
