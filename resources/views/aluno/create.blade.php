@extends('templates.main', ['menu' => 'admin', 'submenu' => 'Novo aluno'])
...
<form action="{{ route('aluno.store') }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="row">
        <div class="col">
            <div class="form-floating mb-3">
                <select 
                    class="form-select @if($errors->has('usuario_id')) is-invalid @endif" 
                    name="usuario_id"
                >
    ...
    <div class="row">
        <div class="col">
            <div class="form-floating mb-3">
                <select 
                    class="form-select @if($errors->has('curso_id')) is-invalid @endif" 
                    name="curso_id"
                >
